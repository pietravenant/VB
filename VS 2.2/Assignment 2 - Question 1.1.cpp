// Assignment 2 - Question 1.1.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
public:
	...
	void display()
	{
		cout << endl << "Street name: " << getStreetName() << " St" << endl << "Street number: " << getStreetNumber() << endl << "City: " << getCity() << endl << "Postal code: " << getPostalCode() << endl;
	}
